...
GMM_FILE="/home/paperspace/Desktop/BalancedMSE/neurips2025/checkpoint/sarcos_gmm_K8.pkl" # Placeholder - replace with actual path/name if needed
...
LOG_FILE="logs/${DATASET}_lds_fds_sqinv_wpcc.${DATETIME_CODE}.log"
